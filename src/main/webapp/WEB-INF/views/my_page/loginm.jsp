	...
	<div class="page" id="login_page">
		<div class="login_wrap">
			...
			<div class="box_login">
					...
					<fieldset>
						...
						<ul class="loginList">
							...
							<div class="box_searchId">
								<a href="http://localhost:9000/findAuth.do" onclick="lgnSearchId();"><span class="ico_searchId">아이디찾기</span></a>
								<a href="http://localhost:9000/find_pass.do" onclick="lgnSearchPwd();"><span class="ico_searchPW">비밀번호찾기</span></a>
								<a href="http://localhost:9000/join.do" onclick="mbrsJoin();"><span class="ico_joinUs">회원가입</span></a>
							</div>
						</div>
				...
				<input type="hidden" name="pagename" class ="input" id="pagename" value="mylogin">
